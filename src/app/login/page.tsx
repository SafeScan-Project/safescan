    ...
    <div className="login-page max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="login-form space-y-4">
        ...
        <input
          ...
          className="login-email-input w-full border rounded px-3 py-2"
          required
        />
        ...
        <div className="login-password-group relative">
          <input
            ...
            className="login-password-input w-full border rounded px-3 py-2 pr-10"
            required
          />
          <button
            type="button"
      ...
      <div className="login-forgot-wrap mt-2 text-right">
        <a href="/reset-password" className="login-forgot-link text-blue-600 underline text-sm">Forgot password?</a>
      </div>
